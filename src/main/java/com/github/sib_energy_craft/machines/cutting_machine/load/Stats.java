...
public final class Stats implements DefaultModInitializer {
    public static final Identifier INTERACT_WITH_CUTTING_MACHINE;

    static {
        INTERACT_WITH_CUTTING_MACHINE = register(Identifiers.asString("interact_with_cutting_machine"), StatFormatter.DEFAULT);
    }
