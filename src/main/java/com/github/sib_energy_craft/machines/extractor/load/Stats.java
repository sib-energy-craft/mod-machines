...
public final class Stats implements ModRegistrar {
    public static final Identifier INTERACT_WITH_EXTRACTOR;

    static {
        INTERACT_WITH_EXTRACTOR = register(Identifiers.asString("interact_with_extractor"), StatFormatter.DEFAULT);
    }
