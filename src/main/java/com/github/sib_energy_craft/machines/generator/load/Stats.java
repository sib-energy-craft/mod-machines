...
public final class Stats implements ModRegistrar {
    public static final Identifier INTERACT_WITH_GENERATOR;

    static {
        INTERACT_WITH_GENERATOR = register(Identifiers.asString("interact_with_generator"), StatFormatter.DEFAULT);
    }
