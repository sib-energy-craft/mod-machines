...
public class InductionFurnaceScreenHandler extends AbstractEnergyFurnaceScreenHandler {
    ...
    public InductionFurnaceScreenHandler(int syncId,
        ...
        super(Screens.INDUCTION_FURNACE, syncId, playerInventory, inventory, propertyDelegate,
                RecipeType.SMELTING, 2, LAYOUT_MANAGER);
    }

    public InductionFurnaceScreenHandler(int syncId,
                                      @NotNull PlayerInventory playerInventory,
                                      @NotNull PacketByteBuf packetByteBuf) {
        super(Screens.INDUCTION_FURNACE, syncId, playerInventory, RecipeType.SMELTING, 2, LAYOUT_MANAGER);
